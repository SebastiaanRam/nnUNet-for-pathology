...
import numpy as np
import torch
from nnunet.training.data_augmentation.diag.data_augmentation_moreDA_ss import get_moreDA_augmentation_pathology
...
class nnUNetTrainerV2_pathology_hagalaz(nnUNetTrainer):
    """
    ...
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        self.num_val_batches_per_epoch = 48
        ...
        if not self.was_initialized:
            ...
            if training:
                ...
                self.tr_gen, self.val_gen = get_moreDA_augmentation_pathology(
                    ...
                    do_hed=self.do_hed,
                    hed_factor=self.hed_factor,
                    do_hsv=self.do_hsv,
                    hsv_h_lim=self.hsv_h_lim,
                    hsv_s_lim=self.hsv_s_lim,
                    hsv_v_lim=self.hsv_v_lim
                )
