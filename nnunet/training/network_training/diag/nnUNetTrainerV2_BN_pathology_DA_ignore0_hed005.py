...
class nnUNetTrainerV2_BN_pathology_DA_ignore0_hed005(nnUNetTrainerV2_BN_pathology_DA_ignore0):
    ...
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        '''
        DAVID's paper: For HSV-light and HSV-strong, 
        we used hue and saturation intensity ratios between [-0.1, 0.1] and [-1, 1], respectively. 
        
        For HED-light and HED-strong, 
        we used intensity ratios between [-0.05, 0.05] and [-0.2, 0.2], respectively, 
        for all HED channels.
        '''
